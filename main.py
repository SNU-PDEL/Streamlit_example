...
st.subheader('40년간 육묘적정온도 비교 (' + location_selectbox + ')' + '(' + str((fruit[fruit['작물명']== cultiva_selectbox]['육묘 시작']).values[0])+ ' ~ ' + str((fruit[fruit['작물명']== cultiva_selectbox]['육묘 끝']).values[0]) + '월)')
