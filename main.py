...
plt.axhline(90, 0, 1, color='blue', linestyle='--', linewidth=2)
plt.axhline(70, 0, 1, color='green', linestyle='--', linewidth=2)
plt.axhline(45, 0, 1, color='#FFCC33', linestyle='--', linewidth=2)
plt.axhline(25, 0, 1, color='orange', linestyle='--', linewidth=2)
